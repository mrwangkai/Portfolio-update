...
//apply_filters( 'wpml_object_id', $featured_post_id, 'post' );
        ...
        <!-- removed the link icon and make the entire slideFromBottom overlay clickable. -->
        <a href="<?php echo get_permalink() ?>" >

          <div class="image_list_bottom portfolio_list da-thumbs">
            <?php
            if(($image_thumb_width>220)&&($image_thumb_height>150)){ ?>
            <div class="image_list_item <?php echo $content_post_turn_on_animation ?  " //animate zoom-in" : ""; ?>" style="background: url(<?php echo $background_image; ?>) no-repeat center !important; background-size:cover !important; ">
              <?php }
              else { ?>
              <div class="image_list_item <?php echo $content_post_turn_on_animation ? " animate zoom-in" : ""; ?>" style="background: url(<?php echo $background_image; ?>) no-repeat center !important;">
                <?php }  ?>
                <article class="da-animate da-slideFromBottom" style="display: block;">

                  <h3><?php
                    the_excerpt();
                    /* yay, it works! Not hover = showing excerpt! although the animation is way too fast / unnatural. */
                    /* self::the_title_max_charlength(40); *
                    /*the_title();*/ ?>
                  </h3>

                  <!-- original spot for link & zoom icon -->
            ...
            <!-- Adding Caption! Next: change text of slide up to Excerpt. And style the caption. -->
            <?php $caption = get_post( get_post_thumbnail_id() )->post_excerpt; ?>
            <div id="post_caption"><?php echo $caption ?></div>
        ...
        <div id="wd-categories-tabs" class="content-inner-block container" data-carousel="<?php echo $review_posts_carousel; ?>" data-interval="<?php echo esc_attr($review_posts_time_interval); ?>" data-stop_animation="<?php echo $review_posts_stop_hover; ?>">
          ...
          <div class="cont_vat_tab">
            <ul class="content">
              ...
              while($wp_query->have_posts()) :
                ...
                <li  id="categories-tabs-content-<?php echo $counter; ?>" <?php if($counter==0) echo 'class="active"'; ?>>
                  <ul>
                    <?php
          ...
          <ul class="tabs">
            ...
            while($wp_query->have_posts()) :
              $wp_query->the_post();
              ?>
              <li <?php if($counter==0) echo 'class="active"'; ?>><a href="#<?php echo $counter; ?>">&#9679;</span></a></li>
              <?php
